...
python -m sample.generate  --lora_finetune --model_path save/mdm/model000500000.pt --styles Chicken  --num_repetitions 1 --input_text ../_texts/person/stairs/stairs.txt --output_dir 'save/out/person_stairs' 
